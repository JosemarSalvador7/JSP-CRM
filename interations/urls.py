...
from interations.views import InteractionListView, InteractionCreateView, InteractionUpdateView, InteractionDelete
...
urlpatterns = [
    ...
    path('interactions/<int:pk>/delete/', InteractionDelete.as_view(), name='interaction-delete'),
]